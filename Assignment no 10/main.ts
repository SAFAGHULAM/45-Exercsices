...
//your programs are too simple at this point, just add your name and the current date
//at the top of each program file. Then write one sentence describing what the program does.

//ctrl+question

//this program adds two number and print the result

//define Two numbers
let number1:number = 11;
let number2:number = 22;
//Add two numbers
